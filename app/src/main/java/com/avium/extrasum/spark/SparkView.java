...
package com.avium.extrasum.spark;
...
import com.avium.extrasum.spark.animation.LineSparkAnimator;
import com.avium.extrasum.spark.animation.SparkAnimator;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (isInEditMode()) {
            this.setAdapter(new SparkAdapter() {
                ...
                @Override
                public int getCount() { return yData.length; }
                @NonNull
                @Override
                public Object getItem(int index) { return yData[index]; }
                @Override
                public float getY(int index) { return yData[index]; }
            });
        }
