...
//    private LinearLayout dotsLayout;
    ...
    com.github.vivchar.viewpagerindicator.ViewPagerIndicator viewPagerIndicator;
//    btnSkip
...
//        btnSkip = (Button) findViewById(R.id.btn_skip);
        ...
        layouts = new int[]{
                R.layout.welcomeslideone,
                R.layout.welcomeslidetwo,
                R.layout.welcomeslidethree,
              };
...
//                btnSkip.setVisibility(View.GONE);
                ...
                btnNext.setText(getString(R.string.start));
//                btnNext.startAnimation(slideDownAnimation);
